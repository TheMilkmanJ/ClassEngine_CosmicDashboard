...
2. **The trace/dyad channel** (ε on fundamental masses): selective (t358's mass-sourcing),
...
GRAVITY itself is never screened (the numeraire cannot suppress itself); what screening
...
weakness is the ADDITION's, not gravity's. The residual addition is the prediction band above.

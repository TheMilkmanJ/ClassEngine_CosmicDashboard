...
"it is a probability wave." The rules (WKB, instantons) are exact; the picture is officially
vacant.

## 1. The model's picture: nothing crosses that wasn't already there

In this ontology a "particle" is an excitation of the medium — and **the medium does not stop
at the barrier**. The excitation's amplitude in the medium extends into the classically
forbidden region as an evanescent profile (exponentially damped medium response — the same
mathematics as evanescent phonons in a superfluid, light in an undersized waveguide, or the
proximity effect in a superconductor). Tunneling is not teleportation through a wall; it is
...
1. **The localization clause** (graded): the vacuum-budget cap used the fact that
...
The null: **exact** reproduction of all tunneling phenomenology — rates, Hartman-type timing
results, macroscopic quantum tunneling in SQUIDs. Any confirmed deviation from standard QM

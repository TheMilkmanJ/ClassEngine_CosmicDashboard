# The Arrow of Time and the Past Hypothesis — Uniqueness (first-genesis; our-cycle gap OPEN) (2026-07-11)

> **EXPLORATORY — not OEM claim authority (2026-08-04).**  
> Not living shelf / not closed theory. Our-cycle Past-Hypothesis gap remains **OPEN**.  
> Nearest living: [`../PRTOE_bigbang_no_singularity.md`](../PRTOE_bigbang_no_singularity.md).  
...
Thermodynamics' arrow needs no explanation *given* a low-entropy past — entropy grows because
there are more ways to be disordered. The real mystery (the **Past Hypothesis**) is why the
...
inherits nothing — and the only state that requires no inheritance is the vacuum. The Past
Hypothesis stops being a hypothesis; it is the *uniqueness theorem of beginnings*: whatever
...
2. **The statement**: the Weyl tensor — gravitational entropy ~ C² (Penrose's hypothesis) —
 and the model's own gate on the electron-coupled scalar — the curvature-metered near-step,
 exp(−(C/C_ref)ⁿ) with n > 2.43 — **is the free-energy gauge** (a recorded formula acquires
 meaning). The medium literally meters the arrow.
...
| standard move | its failure | the PRTOE move |
|---|---|---|
...
| 6 | Arrow terminus / finite chain | **complete-conditional** (finiteness recorded; count not) | §2 item 6 | Cycle count not a recorded number |
| 7 | Thermal-door / white-hole cross-link | **interpretation** | Addendum; [PRTOE_white_holes.md](PRTOE_white_holes.md) | Grammar-grade seating only; not a new derivation |

**Non-claims:** does not close our-cycle Past Hypothesis; does not pin N_cycles; not a production bounce derivation.

**Triage:** elevate-in-place. Physics ceiling: first half derived; second half **OPEN-BLOCKED**.

...
> what is stated here is the kinship. Lasers ride QM+EM exactly. What this file documents is the
> reverse flow: what lasers prove about the grammar the model runs on.
...
## 1\. The threshold IS a condensation transition (the bench rehearsal of T_c)
...
condensation at T_c = 177.10 keV. The universality is not analogy; it is the critical-

...
| `bbn-eps-bound.pdf` | *Primordial helium bounds on a leptonic electron-mass transition inside the BBN window* — 3 pp, astro-ph.CO | **READY** — astro-ph endorsement; optional dense ε_max(T_c) residual (bound at measured T_c). ε 2σ 3.196%≈3.20%: **ARITHMETIC VERIFIED (internal)**; **EXTERNAL WIN PENDING (no DOI)** |

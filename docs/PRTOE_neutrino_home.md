...
condensate; the recorded meV-floor kinship ρ_inf^¼ ~ 2.25 meV vs m_ν-scale). The internal record 383 grouping
...
- the omk run (internal record 333): the dyad's preference SURVIVES curvature being freed (m_ncdm = 0.071);
...
internal record 397 self-catch), Majoron coupling g = 1.2×10⁻⁸ — INSIDE the CMB-S4 band (P-2026-025).
The corner map (internal record 397): S4 tests v_L < 20 MeV ≈ one-third of the natural space. The η route

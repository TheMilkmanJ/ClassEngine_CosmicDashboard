...
| **T5 low-ℓ** | matched-circles; **the cavity C_ℓ computation — RUN 2026-07-18: right shape, 3–5× too little depth at permitted sizes (ledger re-grade)** | — | BipoSH (analysis-limited) | all three escapes computed and dead (none removes long-wavelength modes); **the depth question itself is ungradeable** — 63% cosmic variance, model and observation 0.8σ apart. The gradeable objects are the ℓ = 2–5 shape and the alignment |

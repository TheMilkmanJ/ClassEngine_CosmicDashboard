...
| **T5 low-ℓ** | matched-circles; **the cavity C_ℓ computation — RUN 2026-07-18: right shape, 3–5× too little depth at permitted sizes (ledger re-grade)** | — | BipoSH (analysis-limited) | the named escapes: anisotropic torus, the integrated Sachs–Wolfe piece, or a winding modulation |

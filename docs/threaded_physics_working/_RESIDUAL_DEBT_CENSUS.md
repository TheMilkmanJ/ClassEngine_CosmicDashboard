...
| **T5 low-ℓ** | matched-circles; **the cavity C_ℓ computation — RUN 2026-07-18: right shape, 3–5× too little depth at permitted sizes (ledger re-grade)** | — | BipoSH (analysis-limited) | **only one escape left**: a winding modulation beyond the mode cutoff (anisotropy and the integrated Sachs–Wolfe piece are computed and both fail) |

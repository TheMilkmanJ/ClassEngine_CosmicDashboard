...
it is (like the threads) a small-rooted tree. Booked internal record 453.*
...
| M2 | **THE CARD-4 SOLVE + SIGN MAP** | form FIXED (η = n × junction transmission); the integral RUN at estimate grade (records 28/30/36: reservoir 1.9×10⁴× the need; the sphaleron-weighted careful pass still owed) | η, T14's dictionary, T10's n-sign, the chirality family's readability, the matter-sign linkage — ~6 |
| M3 | **THE LORENTZ PROGRAM** | LV pricing PAID (the blindness shield, 12–38 orders); induced-G DECOMPOSED (4/5 recorded/paid/priced); residue = THE BASEMENT ROSTER (task #18) | F-F/area law/no-bare-G (the keystone → 5 docs), W-W pricing, the LV ledger, the wing's frame notes — ~7 |
...
| M5 | **THE CHAINS** (the thaw chain/conv_desi convergence) | PAUSED pre-convergence (thaw mid-burn-in; conv_desi at the gate) — queued behind the evidence runs | conv_g (T3+T4 jointly), the thaw posterior, the internal record 325 pre-registrations — ~4 |
...
- M3 ↔ M4: the medium's UV completion (the Planck basement, internal record 427) plausibly fixes BOTH the

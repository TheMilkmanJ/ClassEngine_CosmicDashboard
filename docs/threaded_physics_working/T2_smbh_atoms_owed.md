# T2 SMBH atoms — OWED
1. THE GROWTH-RATE COMPUTATION (t416's one physics check): superradiance shuts off for α_g ≳ 0.5 dominant modes — compute the actual window placement/timescales; does the level structure land in an observable spin-mass range?

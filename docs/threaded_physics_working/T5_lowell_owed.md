...
2. THE MATCHED-CIRCLES CHECK (t416 flag: existing nulls may already exclude an observably-small torus — reconcile with L ≥ 27.6 Gpc).
3. BipoSH/isotropy policing of the axis family (jointly with P-024/P-029 — t400's estimator-class check).

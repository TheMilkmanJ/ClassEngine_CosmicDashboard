...
| the mass-top triple coincidence (α_g=1 / r_s=ξ / CSW-max) | m-correlated, noted-only (t450) | the α_c MCMC posterior + an SMBH mass-function mechanism |
...
## THE CROSS-COMPARISON PASS (author-directed, internal record 489): each parked item vs all domains

...
| the double-ladder alignments (web/mesoscale) | loose coincidences, no mechanism (internal review) | a derivation linking ξ_K or 1/M₂ to the matter transition |
| the generations lane (3 cycles = 3 families) | a 3=3 match without a mechanism (internal review) | the flavor-from-winding construction |
...
| the mass-top triple coincidence (α_g=1 / r_s=ξ / CSW-max) | m-correlated, noted-only (internal review) | the α_c MCMC posterior + an SMBH mass-function mechanism |
...
## THE CROSS-COMPARISON PASS (author-directed, internal review): each parked item vs all domains

...
| the chiral-GW amplitude | COMPUTED (hunt 179): chirality asymmetry 5×10⁻²⁴ (LIGO) to 5×10⁻¹⁴ (PTA) at the recorded swirl θ̇ — a clean null-class prediction; detection above these levels = a model-killer | closed — graduates to the null board |

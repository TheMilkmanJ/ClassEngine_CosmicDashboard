# T9 direct detection — OWED
1. COMPUTE THE ACTUAL TRACE-CHANNEL RECOIL CROSS-SECTION (show the number, not just "no particle to recoil"): σ per nucleon from the c~0.9 gravitational-strength coupling at m = 2.24e-20 eV — quantify "below any conceivable reach."

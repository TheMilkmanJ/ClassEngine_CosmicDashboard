...
- physical chem [S] → quantum chem [R] · thermochem [O-inherited] · electrochem [S]
- inorganic [I] · organic [I] · analytical [S: spectroscopy trusts constant lines — the fence]
- astrochem [C: the z>50 ε-history, P-030 mid-ramp lines] · geochem [I→ feeds GEN 9]
...
- astrobiology [C: the license's cosmic scope — where the account permits far-from-eq eddies]
...
# THE COMPLETENESS AUDIT: the full taxonomy vs our coverage

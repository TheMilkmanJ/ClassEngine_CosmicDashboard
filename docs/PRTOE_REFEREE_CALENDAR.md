...
| **CMB-S4 Majoron search** | the v_L corner selector (both corners lane-clean) — **and now the deuterium repair route's source**, which needs a state at ≳20 MeV living 10⁶–10⁸ s (BBN witness) | a detection at g ~ 10⁻⁸–10⁻⁹ selects the MeV corner and supplies a candidate source; a null leans high-v_L and leaves the repair route without one |

...
| **CMB-S4 Majoron search** | the v_L corner selector (both corners clear every applied constraint). **Not** the deuterium-scar injector: the EM repair spec needs a state ≳20 MeV living 10⁶–10⁸ s, and the MeV corner is a *scale* (v_L ≈ 4.2 MeV) whose RH seats sit below the ⁴He threshold — see `PRTOE_deuterium_scar.md` §6/§8 | a detection at g ~ 10⁻⁸–10⁻⁹ selects the MeV corner; a null leans high-v_L. Neither outcome fills the scar's missing source by itself |

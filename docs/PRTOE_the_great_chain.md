...
| 5 | ε(T) = ε(1−T/T_c); elasticities: ∂lnY_p/∂lnm_e ≈ 0 above T_c, windowed Y_p **+0.85%** (restated 2026-07-16 — the +1.1% was the LT *step*; this is the ramped value) | Y_p = **0.24900** (**+1.09σ** counter); D/H **2.4305** with the η-flow (**−3.2σ**, not the 1.9σ previously recorded — see the witness) | PRyM (BBN), ramped splice |

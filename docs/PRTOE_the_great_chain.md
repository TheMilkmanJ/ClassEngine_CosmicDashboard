...
**GEN 7 — THE DRAWDOWN.** Smoothness is my savings (the gravity account); structure is
...
| thermodynamics | dE = T dS − p dV; dS ≥ 0 | **natively OURS** | the account IS the first law; the arrow IS the drawdown (graded chain) |

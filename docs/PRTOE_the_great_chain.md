...
| 5 | ε(T) = ε(1−T/T_c); elasticities: ∂lnY_p/∂lnm_e ≈ 0 above T_c, windowed Y_p +0.85% | under the standing configuration's committed genesis window: joint p = 0.15–0.29, deuterium −0.3 to −1.2σ from Cooke, helium +1.3 to +1.8σ against Aver (the EMPRESS fork sits apart at ≈ +4σ) | PRyM (BBN), ramped splice |

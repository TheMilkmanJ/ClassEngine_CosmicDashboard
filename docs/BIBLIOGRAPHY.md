...
- **[Cooke2018]** R. J. Cooke, M. Pettini, C. C. Steidel, "One percent determination of the primordial deuterium abundance," ApJ 855, 102 (2018), arXiv:1710.11129. — D/H = (2.527 ± 0.030)×10⁻⁵ — the observational pole of the D/H fork; the model predicts 2.387×10⁻⁵, **−2.9σ** on the full budget (obs ±0.030 ⊕ PRIMAT theory ±0.037 = ±0.0476).

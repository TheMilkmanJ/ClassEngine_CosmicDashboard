...
- **[Moffatt1969]** H. K. Moffatt, "The degree of knottedness of tangled vortex lines," J. Fluid Mech. 35, 117 (1969). — Helicity as linkage: H = Σᵢ Γᵢ²(Wr + Tw) + 2Σ_{i<j} Γᵢ Γⱼ Lk_ij. The theorem that makes P-2026-028's seeding sign **bilinear** in the genesis ring's poloidal and toroidal circulations rather than linear in one winding integer — the self-term squares sign(n) away (T14's link 4).

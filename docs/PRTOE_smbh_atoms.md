...
That band is populated, and several black holes inside
...
This is the thread's own item 3, and it joins the
...
Which quartic enters was the question that had to be settled first. Two values were in play,
...
Resolving p was the owed calculation, but p is not what kills
...
The model meets P-2026-034 **as a free scalar** — at f_eff = 5×10¹⁶ GeV the

...
account** — a standing negative posting that never settles. The settlement law
(least-cost clearing) closes any local negative fluctuation on the medium's own
timescale; the clearinghouse extends no eternal credit. The medium's bulk sector cannot
...
nine words: *you'd have to make zero-point energy owe you money.*

**The price tag (the honest ledger entry):** the model DOES own one NEC-flexible sector —
...
Any laboratory or astrophysical demonstration of macroscopic, sustained NEC violation
beyond the quantum-inequality allowances [FordRoman1995] — negative energy held static at
a scale and duration the bounds forbid — would break the no-overdraft law and reopen this
file. The 17-order pricing additionally falls if the ghost-branch DOS computation is
overturned.

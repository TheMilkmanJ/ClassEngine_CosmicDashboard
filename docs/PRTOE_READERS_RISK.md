...
early / CDM-like late. A second field (the dyad) shifts the electron mass by a fractional amount
ε ≈ 1.24%, active pre-recombination and screened off late. Gravity is treated as induced/GR, with no
bare cosmological terms. The entire modification to known physics is one number, ε, applied
everywhere atomic physics appears.

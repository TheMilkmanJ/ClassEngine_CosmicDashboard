...
| 4 | Fit status / multi-basin stopped run not quotable; H₀ ≈ 69.9 and “outperform” demoted; live R−1 lcdm **0.049324**@N=26294 t=2026-08-05T11:52:10 (`converged:true`; control leg ready) / dyad **0.056889**@N=24677 t=2026-08-05T07:54:30 (**1.14×**, `converged:false`) | **honest constraint** | status section; progress | **NOT bookable**; no peek H₀ as result; joint waits `dyad_mnu_bbnfix` book via `book_bbnfix_when_ready.py` |

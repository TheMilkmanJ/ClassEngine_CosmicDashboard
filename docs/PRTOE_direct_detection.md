...
Billions of dollars of exquisite instruments — nuclear-recoil TPCs (XENONnT/LZ/PandaX), axion
haloscopes (ADMX-class), light-shining-through-walls, fifth-force torsion balances — have
returned null after null. For WIMP/axion paradigms each null shrinks a parameter space that
was always adjustable. This model has no room to adjust:

## 1. The forced nulls (each from a graded object)

| channel | the model's verdict | forced by |
|---|---|---|
| axion haloscopes / LSW (dark matter ↔ photons) | **NULL, forever** | EM-neutrality forced to 25–45 orders (Meissner/photon-mass, t330); the birefringence anomaly-zero (L1a, banked) |
| nuclear recoil (dark matter ↔ quarks, contact) | **NULL at all reachable cross-sections** | the medium is a condensate of 2×10⁻²⁰ eV quanta — no particle-like recoils exist; the only matter coupling is the trace channel at gravitational-strength-class (c ~ 0.9, def407-era) |
| fifth-force / EP torsion balances | **NULL within current reach** | the EP/Vainshtein gate cleared with 5-order margin (banked distinctive-standing) |
| collider missing-energy production | **NULL** | the portal scale at ~3.5×10¹⁷ GeV (def357's geometric mean); vector-like leptons collider-safe by construction (banked) |
...
P-027's arbiter, P-029's comb), **CMB-S4's neutrino sector** (the Majoron corner, P-025 —
...
model earns nothing further from continued silence — the asymmetric bet it has already banked
in other columns (Tsirelson-class). As detectors reach the neutrino fog with no signal, every
adjustable paradigm shrinks and this model simply remains.

*Forty years of silence underground was a scan coming up empty. In this model it was the

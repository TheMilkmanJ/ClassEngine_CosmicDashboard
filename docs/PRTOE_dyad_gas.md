...
([PRTOE_dcdf_superfluid.md](PRTOE_dcdf_superfluid.md)).*
...
## 2. Leptophilic: the Majoron [ESTABLISHED]
...
|---|---|---|
| charge | abundance / asymmetry | **lepton number** |
| symmetry role | chiral / parity-odd | **electron-coupling / L-breaking** |

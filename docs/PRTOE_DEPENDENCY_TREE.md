...
| ρ_Λ = E_b⁴ (the pinch) | occupancy-one + BEC-side ownership | [D] (½α_c²M₂ = 2.251 meV, 4×10⁻⁴; but M₂ selected by the same closure — one constraint, three names — and α_c-conditional) | the crossover corollary fails |

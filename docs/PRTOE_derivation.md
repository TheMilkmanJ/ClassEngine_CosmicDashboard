...
- **[DERIVE]** Thin-shell factor: eq. (6) gives the interior field value; the exterior
  fifth-force also carries the thin-shell suppression ΔR/R for compact bodies. Current
  bound check is conservative without it.

...
| 11 | Inflation / genesis | DOOR | AD genesis: chaos in release angle, ε is a dice roll; Z4 tilt assumed (forcedness reopened — basement rebuild, hunt 132b/139); launderer = depositor; recursion wall kept visible | Room 1 E3–E8, Room 4 |
...
| 28 | Consciousness / quantum mind | NULL (firewall) | Neural decoherence 10–17 decades below signaling: the brain is a classical ledger; the file cannot be recruited for quantum-mind claims | atlas: burn set 3 |

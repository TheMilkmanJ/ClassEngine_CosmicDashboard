...
Reading the map: 3 standing bets (labs, telescopes, Λ) · 1 live-now test (superradiance —
the mass is now pinned three independent ways, so the confrontation cannot be relieved by
moving it) · 2 simulation-gated axes (granule ε-meter, sole; Room 5 χ-lag) · 1 dead arm
with an honest headstone (PTA, killed by mass, pre-called) · 1 healthy converging judge
(Σm_ν → P-2026-004 falsified, now testing the surviving meV whisper) · 8+ clean nulls with
numbers · 2 structural silences · 1 honest strain (deuterium, repriced) · 1 identity.

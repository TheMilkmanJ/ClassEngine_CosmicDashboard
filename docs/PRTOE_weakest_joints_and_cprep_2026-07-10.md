...
- **NEW STANDING RISK:** the D/H fork (ramped bet: 2.387 vs the quasar 2.527; width owed) AND the Y_p reversal (+1.3σ counter, internal review — the medicine was an artifact).

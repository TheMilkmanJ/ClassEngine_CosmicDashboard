# BBN — The Transition's Witness (standalone for internal review)
...
- windowed elasticities (production PRyM, spliced rates, internal review): Y_p → 0.2495–0.2505
...
posterior. History: wall → pharmacy → artifact → WITNESS (internal review→325→449→465) — each
...
## The lithium row — CLOSED AS A NULL (the working docket-07-12)

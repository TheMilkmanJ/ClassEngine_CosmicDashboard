...
| The cosmological constant | The vacuum energy budget is capped at the pairing gap by a no-double-counting constraint; the resulting floor value is *computed*: ρ^{1/4} = 2.7 meV against the measured 2.25 meV — 20%, with zero adjustable parameters | derived; 20% residual open |

...
|---|---|---|---|---|
| 1 | ε at recombination lifts H₀ relative to ΛCDM | **machine-backed** | production fit; old-BAO booking receipt; CLASS | Historical fixed-ε ~69.9 line remains pre-bbnfix; current booked old-BAO dyad is **70.052 ± 0.716**; DESI-DR2 Stage A **booked** (SH0ES + TRGB, do not mix). Nested twins **open** |
| 2 | Ladder ceiling ~70.9–71.3; cannot reach 73 | **machine-backed** | H0_CEILING; ς = −1 | Residual tension owned |
| 3 | Evidence remains marginal | **machine-backed** current + historical | booked old-BAO sample-cov Laplace; earlier MCMC Laplace | **OPEN-NESTED:** current booked old-BAO pair is only **ΔlnZ ≈ +0.21**; DESI-DR2 SH0ES Laplace **ΔlnZ ≈ +1.31** (not nested); historical **+2.6** remains pre-bbnfix; nested **launched**, no twin ΔlnZ |
| 4 | ε stack c·f̄·α_c conditional | **complete-conditional** | THE_AMPLITUDE | zon_disp **STOPPED**, `log10_zon` **INCONCLUSIVE** |
...
| 8 | Current-stack nested-quality H₀ / model−ΛCDM evidence sentence | **OPEN-BLOCKED** | residual freeze 2026-08-08 | **OPEN-NESTED** only: Stage A booked; nested **launched**, no twin ΔlnZ |
...
**Triage:** elevate-in-place. Physics ceiling: mechanism production-grade; Stage A booked on old-BAO SH0ES, DESI-DR2 SH0ES, and DESI-DR2 TRGB; current-stack evidence still **OPEN-NESTED** only.

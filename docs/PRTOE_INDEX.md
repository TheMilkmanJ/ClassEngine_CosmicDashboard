...
|---|---|---|
| **Production chains (bbnfix old-BAO pair)** | **BOOKED.** Receipt: dyad **R−1 0.048118**@N=37605 `converged:true`, lcdm **0.049324**@N=26294 `converged:true`; three-rank GetDist is now on receipt for H₀ / `m_ncdm` / S₈. Evidence honesty: sample-cov Laplace only **ΔlnZ ≈ +0.21** with **cond(Σ) ~ 10⁸**. Production Stage A is **booked** on three stacks: old-BAO SH0ES, DESI-DR2 SH0ES, and DESI-DR2 TRGB (do not mix anchors). Route-D MCMC is finished/idle (Stage A booked 2026-08-10). Nested sampling is launched; LCDM UltraNest one-legs are finished; dyad UN + PolyChord are unfinished. Nested ΔlnZ is **not** booked. zon_disp and conv_desi are **STOPPED** and **INCONCLUSIVE**. Full table: [PRTOE_CHAIN_TABLES.md](PRTOE_CHAIN_TABLES.md) | A decisive evidence win; mixing booked old-BAO posteriors with DESI-DR2 posteriors |
...
[domain coverage map](PRTOE_DOMAIN_COVERAGE.md) · [chain tables](PRTOE_CHAIN_TABLES.md) (Stage A **BOOKED** on old-BAO SH0ES, DESI-DR2 SH0ES, DESI-DR2 TRGB; nested twins open, no nested ΔlnZ) ·
...
**Non-claims:** no physics COMPLETE from this file alone; **not** H₀ win; **not** Page closed; **not** nested ΔlnZ booked.

...
Currency only — not a physics COMPLETE. Sources: `CHAIN_TABLES` freeze, booking refuse card `bbnfix_booking_20260805_190348`, `page_full_freeze_20260804`, `STRONG_CP_SEAT_HUNT`. Package: [`working_logs/_runs/docs_full_check12_20260805/`](working_logs/_runs/docs_full_check12_20260805/).
...
|---|---|---|
| **Production chains (bbnfix pair)** | **NOT bookable.** Progress: lcdm R−1 **0.049324** (N=26294, t=2026-08-05T11:52:10; `converged: true`; control leg ready), dyad R−1 **0.056889** (N=24677, t=2026-08-05T07:54:30; **1.14×** stop; `converged: false`); one ready leg does **not** open the pair, so `book_bbnfix_when_ready.py` still → **REFUSED**. GetDist GR diagnostic only. Route-D live R−1 **0.728432**@N=8120 t=2026-08-05T12:54:11 (~**7.28×** stop 0.1) — not dual-gate. Full table: [PRTOE_CHAIN_TABLES.md](PRTOE_CHAIN_TABLES.md) · refuse card [`bbnfix_booking_20260805_190348`](working_logs/_runs/bbnfix_booking_20260805_190348/) | Booked H₀ / Σm_ν / S₈; peek-book; GR-as-gate |

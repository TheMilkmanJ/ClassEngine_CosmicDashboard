...
|---|---|---|
| **Production chains (bbnfix old-BAO pair)** | **BOOKED.** Receipt: dyad **R−1 0.048118**@N=37605 `converged:true`, lcdm **0.049324**@N=26294 `converged:true`; three-rank GetDist is now on receipt for H₀ / `m_ncdm` / S₈. Evidence honesty: sample-cov Laplace only **ΔlnZ ≈ +0.21** with **cond(Σ) ~ 10⁸**. DESI-DR2 SH0ES and DESI-DR2 TRGB Stage A are **BOOKED** (do not mix anchors). Route-D MCMC is finished/idle (Stage A booked 2026-08-10). On SH0ES, nested sampling got close enough to compare the twins, not far enough to book a full sampler. No nested ΔlnZ. zon_disp and conv_desi are **STOPPED** and **INCONCLUSIVE**. Full table: [PRTOE_CHAIN_TABLES.md](PRTOE_CHAIN_TABLES.md) | A decisive evidence win; mixing booked posteriors across anchors |
...
[domain coverage map](PRTOE_DOMAIN_COVERAGE.md) · [chain tables](PRTOE_CHAIN_TABLES.md) (Stage A **BOOKED** for old-BAO SH0ES, DESI-DR2 SH0ES, and DESI-DR2 TRGB; nested twins still open) ·
...
**Non-claims:** no physics COMPLETE from this file alone; **not** H₀ win; **not** Page closed; **not** a nested evidence win (Stage A MCMC is booked).

...
derivation) or WHETHER it beats LCDM (evidence pending). **The evidence class is
...
2. **FIT (that it works): DONE, competitive.** H0=69.7, S8 eased, chi2 tie-to-
   slight-edge vs LCDM at +1 param across Planck+ACT+SPT+BAO+SN. Both tensions
   eased directionally at ~zero chi2 cost.
3. **MECHANISM + EVIDENCE (why / whether it wins): OPEN.** m_e mechanism = fit
   with candidate derivation (Path A) pending two gates. Evidence (beats LCDM?)
   pending Fairbank/PolyChord.

## Open questions, tiered by what can move "flat"
- **TIER 1 — the movers:** Fairbank Sigma-m_nu posterior (R-1=0.98, converging,
...
- **TIER 3 — sims owed:** two-field granule runs (epsilon-meter, mass pin, Room 5
  chi-lag).
...
P-2026-001 (TRGB, H0 in [69,71], no hedge); P-2026-004 (Sigma-m_nu in [0.11,0.17],
...
haloscope; Lambda exactly vs DESI DR2).
...
a public graveyard — rare and real. It has NOT crossed from "fits as well as LCDM"

...
**Standing / red:** **DENIED** (batch9 / third denial — see residual-task `STATUS.md`)
...
- §4.2 monotone envelope u=max v (**proposed / not pre-ratified for claim** until seats agree)
- Scorecard only from full arrays
- Script content hash for T6 if untracked
- T8 single-valued \(S(u)\) **proposed**, awaiting ChatGPT — not active

# SCORECARD — champion `coevolve_v13` (D4 package arrays-only re-run)

**Package:** `page_d4_microphysics_20260804`  
**Date:** 2026-08-04  
...
| tool_sha256 (this run) | `06bd9661be39d1ff…` (full stamp in log / recompute JSON) |
| Scorecard write | `.../page_curve/coevolve_v13_scorecard_recompute.json` (rewritten by tool; numbers match freeze) |
...
| stall / coevo co_frac / swap / peak | **PASS** | (as in freeze snapshot; binding stack intact) |
...
| S range in bin | 0.0018883423986319587 | |
...
**Protocol (F1):** future T8_pass filings must report early-bin range and S⋆ separately vs v13 and state which moved. Pure S⋆ inflation = fake pass (DEAD_DENIFY).

...
| **T-M1** | bbnfix dual-gate book | **NOT_BOOKABLE** | machine dual gate | inventory T-M1; chains + book scripts | R−1 still above gate (inventory: 0.071122 / 0.072286); **no peek-book** |

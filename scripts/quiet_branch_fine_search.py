...
def main() -> None:
    ...
    if any_quiet == 0:
        ...
        print(f"   resolution. Closest approach: f_amp = {closest:.5f}, still")
        print(f"   {closest/QUIET:.1f}x above the threshold. #36's conclusion is not a")
        print("   sampling artifact — every draw rings at the physical")
        print("   hierarchy, and the granule meter keeps its readout.")
    else:

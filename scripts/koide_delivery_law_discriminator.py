...
print()
print("    (b) the delivery law is not thermal. The occupancy lock is the live alternative")
print("        and it is a cold, quantum law -- which is the right CLASS for a 6e-6 claim,")
print("        since an integer occupancy cannot drift while a thermal ratio can. Its debt")
print("        is now named and it is a single condition.")
print()

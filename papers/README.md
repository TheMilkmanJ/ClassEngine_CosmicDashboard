...
- **`kination-tracking-note/`** is a pure negative sector result: a rotating condensate tracking
  $V\propto r^n$ has exact $w=(n-2)/(n+2)$ and cannot reach kination below trans-Planckian amplitude.
...
| radio-lattice | **Yes** — `main.tex` + `main.bbl`; 7 pp | None. DM demotion is in the text. | astro-ph endorsement |
| lattice-tc-gap | **Yes** — `main.tex` only; 2 pp | None as a gap note (no lattice result claimed). Red-team pass 2026-08-02. | hep-lat endorsement |
| bbn-eps-bound | **Yes** — `main.tex` only; 3 pp | Dense ε_max(T_c) curve over [70, 500] keV not produced (bound at measured T_c only; scan method stated). Red-team pass 2026-08-02. | astro-ph endorsement |
| kination-tracking-note | **Yes** — `main.tex` only; 2 pp | Optional: deeper literature engagement on charged Q-balls / complex-scalar cosmology. Draft from corpus 2026-08-02. | gr-qc endorsement |

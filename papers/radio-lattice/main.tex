...
rather than by precision. A single band deviating from its assigned weight falsifies the pattern.
\end{abstract}
...
$21\,$cm comparison already bounds the amplitude at $|\varepsilon| < 1.4 \times 10^{-5}$ over
$1.17 < z < 1.56$, with the systematic five times the statistical error. That ordering is the
argument for the pattern rather than against it: a ratio taken between bands whose systematics are
unrelated is limited by neither alone.

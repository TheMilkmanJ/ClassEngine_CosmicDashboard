...
nuclear moments~\cite{WolfeBrownRoberts1976,Tzanavaris2005}. Its scale is the Rydberg reduced by the ratio of the nuclear to the Bohr
...
\end{equation}
%
The measured quantity is $t_{\rm DM}$; the reported dispersion measure is obtained by dividing out~\cite{Kulkarni2020}
...
\begin{equation}
  \boxed{\;
  w_{21} : w_{\rm RRL} : w_{\rm DM} : w_{\rm sync} : w_{\rm RM}
  \;=\; +2 : +1 : -1 : -1 : -2 \;}
  \label{eq:pattern}
\end{equation}
%
...
\emph{Linearity.} Existing bounds on a varying electron mass from big-bang nucleosynthesis and the microwave background place $|\varepsilon|$ at the percent level or below~\cite{SetoToda2023,HartChluba2020}. We work to first order in $\varepsilon$. For $|\varepsilon| \lesssim 10^{-2}$ the
quadratic terms enter at the $10^{-4}$ level, below the precision of any of the measurements
considered here.
